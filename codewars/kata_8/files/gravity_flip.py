...
which can be either 'L' or 'R' (left or right). Below is an example of what a box of cubes might
...
def flip(direction, boxes_list):
    """return sorted list corresponding with direction param"""
    return sorted(boxes_list) if direction == 'R' else sorted(boxes_list, reverse=True)
